...
<body>
    ...
    <h1><a href="http://localhost:8080" style="text-decoration: none; color: inherit;">Music Player</a></h1>
    ...
    <audio id="audio" controls type="audio/mpeg"></audio>
                ...
                <div class="modal-body">
                    <form action="/add" method="post">
                        ...
                        <select name="playlist" class="form-control">
                            <?php foreach ($playlists as $play) : ?>
                                <option value="<?= $play['id'] ?>"><?= $play['name'] ?></option><br>
                            <?php endforeach; ?>
                        </select><br>
